  ...
  return (
    <div className="flex justify-start items-start ml-5">
      ...
      >
        ...
        >
          <h1
            className="font-serif text-[9px] md:text-2xl font-bold leading-tight text-left mt-5 bg-gradient-to-r from-blue-800 via-blue-400 to-blue-800 bg-[length:200%_auto] text-transparent bg-clip-text animate-text-shine"
