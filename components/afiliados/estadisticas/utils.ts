...
export const PIE_CORNER_RADIUS = 10;
export const PIE_PADDING_ANGLE = 6;
...
export const chartStyles = {
  card: "w-full h-full flex flex-col min-h-[400px]",
  cardCompact: "w-full h-full flex flex-col p-2",
  headerTitle:
    "text-xs md:text-xl font-bold text-gray-800 dark:text-zinc-100 uppercase",
  headerTitleSm:
    "text-xs md:text-lg font-bold text-gray-800 dark:text-zinc-100 uppercase text-center md:text-left",
  headerSubtitle:
    "text-sm text-gray-500 dark:text-zinc-400 italic text-center md:text-left",
  headerSubtitleLeft: "text-sm text-gray-500 dark:text-zinc-400 italic",
  footer:
    "mt-4 text-center text-[10px] text-gray-400 dark:text-zinc-500 shrink-0 uppercase font-bold border-t border-gray-100 dark:border-zinc-800 pt-4",
